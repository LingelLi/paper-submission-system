...
public interface StudentMapper {
    ...
    int updateStudentByUserId(@Param("user_id")String user_id,@Param("teacher_name")String teacher_name,@Param("teacher_institution")String teacher_institution,@Param("teacher_major")String teacher_major);
    Student getStudentByUserId(String userId);
    
    User getUserByStudentId(String studentId);
    
    Student getStudentByStudentId(String studentId);
    Student getTeacher(String user_id);
