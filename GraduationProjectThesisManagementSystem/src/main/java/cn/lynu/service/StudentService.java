...
public class StudentService {
	...
	public Student getTeacher(String user_id) {
		return studentMapper.getTeacher(user_id);
	}
	...
	@Transactional(propagation=Propagation.REQUIRED)
	public int updateStudentByUserId(String user_id,String teacher_name,String teacher_institution,String teacher_major) {
		return studentMapper.updateStudentByUserId(user_id,teacher_name,teacher_institution,teacher_major);
	}
